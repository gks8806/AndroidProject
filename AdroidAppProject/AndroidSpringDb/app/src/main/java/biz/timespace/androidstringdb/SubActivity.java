...
public class SubActivity extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://192.168.100.2:8080/android/list"; // 반드시 유효한 IP를 사용해야 합니다. localhost.127.0.0.1불가
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        DialogInterface.OnClickListener deleteListener = new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface arg0, int arg1){
                //DB삭제
                String url = "http://192.168.100.2:8080/android/delete/"+data; //스프링(자바)한경일때
